...
public class DatabaseManager {
    ...
    // Tambahkan metode closeConnection jika diperlukan, meskipun try-with-resources sudah menangani penutupan
    // Pastikan semua akses database menggunakan try-with-resources seperti di atas
}